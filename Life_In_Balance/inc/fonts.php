...
function life_in_balance_get_google_fonts() {
 ...
 */
function life_in_balance_get_font_families_options() {
 ...
 */
if ( !function_exists('life_in_balance_enqueue_google_fonts') ) :
	function life_in_balance_enqueue_google_fonts() {

		//Get user choices for font families
		$fonts 				= life_in_balance_get_font_families_options();
 ...
 */
function life_in_balance_migrate_fonts() {
...
add_action( 'after_setup_theme', 'life_in_balance_migrate_fonts' );