...
function life_in_balance_toolbox_register_clients() {

	$slug = apply_filters( 'life_in_balance_clients_rewrite_slug', 'clients' );

	$labels = array(
		'name'                  => _x( 'Clients', 'Post Type General Name', 'life_in_balance_toolbox' ),
		'singular_name'         => _x( 'Client', 'Post Type Singular Name', 'life_in_balance_toolbox' ),
		'menu_name'             => __( 'Clients', 'life_in_balance_toolbox' ),
		'name_admin_bar'        => __( 'Clients', 'life_in_balance_toolbox' ),
		'archives'              => __( 'Item Archives', 'life_in_balance_toolbox' ),
		'parent_item_colon'     => __( 'Parent Item:', 'life_in_balance_toolbox' ),
		'all_items'             => __( 'All Clients', 'life_in_balance_toolbox' ),
		'add_new_item'          => __( 'Add New Client', 'life_in_balance_toolbox' ),
		'add_new'               => __( 'Add New Client', 'life_in_balance_toolbox' ),
		'new_item'              => __( 'New Client', 'life_in_balance_toolbox' ),
		'edit_item'             => __( 'Edit Client', 'life_in_balance_toolbox' ),
		'update_item'           => __( 'Update Client', 'life_in_balance_toolbox' ),
		'view_item'             => __( 'View Client', 'life_in_balance_toolbox' ),
		'search_items'          => __( 'Search Client', 'life_in_balance_toolbox' ),
	...
	$args = array(
		'label'                 => __( 'Client', 'life_in_balance_toolbox' ),
		'description'           => __( 'A post type for your clients', 'life_in_balance_toolbox' ),
		'labels'                => $labels,
...
add_action( 'init', 'life_in_balance_toolbox_register_clients', 0 );