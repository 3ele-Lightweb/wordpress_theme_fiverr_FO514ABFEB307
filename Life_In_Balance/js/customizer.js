...
( function( $ ) {
	...
	wp.customize( 'body_font', function( value ) {
		value.bind( function( to ) {
			...
			$( '#life_in_balance-preview-google-fonts-body-css' ).attr( 'href', 'https://fonts.googleapis.com/css?family=' + to.replace(/ /g, '+') + '&display=swap' );
	...
	wp.customize( 'headings_font', function( value ) {
		value.bind( function( to ) {
			...
			$( '#life_in_balance-preview-google-fonts-headings-css' ).attr( 'href', 'https://fonts.googleapis.com/css?family=' + to.replace(/ /g, '+') + '&display=swap' );
