...
class Life_In_Balance_Services_Type_A extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'life_in_balance_services_widget', 'description' => __( 'Show what services you are able to provide.', 'life_in_balance') );
        parent::__construct(false, $name = __('Life_In_Balance FP: Services Type A', 'life_in_balance'), $widget_ops);
		$this->alt_option_name = 'life_in_balance_services_widget';
	...
	<label for="<?php echo $this->get_field_id( 'two_cols' ); ?>"><?php _e( 'Display services in two columns instead of three?', 'life_in_balance' ); ?></label></p>
